...
Usable. The plan engine and the apply phase both work end to end, covered by 120 tests
including 39 that drive the real binary against real rclone with no network.
