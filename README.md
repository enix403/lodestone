...
Usable. The plan engine and the apply phase both work end to end, covered by 117 tests
including 38 that drive the real binary against real rclone with no network.
